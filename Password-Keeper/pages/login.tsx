...
import { setJwt } from "@/components/jwtService";
...
const Login: React.FC = () => {
  ...
  const handleLogin = async () => {
    ...
    if (!isPasswordValid(password)) {
      ...
      const url =
        "https://proxy-https.vercel.app/secret-app-authentication/authenticate";
      ...
      try {
        ...
        setOpen(true);
        setErrorText("please check the username and password");
      }
    }
  };
        ...
        <div className="justify-center mt-40 items-center">
          <Container maxWidth="xs">
            ...
            <Button
              ...
              onClick={handleLogin}
            >
              <p className="m-0 p-0 font-extrabold">Login</p>
            </Button>
