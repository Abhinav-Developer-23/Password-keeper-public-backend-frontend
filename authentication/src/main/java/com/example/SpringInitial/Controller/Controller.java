...
public class Controller
{
    ...
    public ResponseEntity<?> getPasswordByEmailAndTitle(@RequestBody GetAllTitles getAllTitles)
    {

        ResponseEntity<?> response=passwordSavingServiceProxy.getAllTitles(getAllTitles);
